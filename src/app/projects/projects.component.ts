...
{
    public filterButtons: string[] = ['All', 'Hardware', 'Web Sites', 'Games', 'Tools / Other'];
        ...
        private cfr: ComponentFactoryResolver, private dom: DomSanitizer)
    {
        ...
        [
            {
                type           : ["Games"],
                image          : "/assets/beats/kda_pic.jpg", 
                title          : "Rhythm Game Demo",
                date           : new Date("February 19, 2022"),
                subtitle       : "TypeScript", 
                description    : "A rhythm game demo I built over the weekend for fun using artwork & music from Riot Games, League of Legends",
                link           : "rhythm-game-demo",
                details        :    [
                                        { 
                                            heading   : 'Overview', 
                                            notes     : `I built this rhythm game over the weekend for fun.
                                                        ...
                                                        "'a' 's' 'd' 'f' 'spacebar' 'j' 'k' 'l' ';'"
                                                        to match the sequence! (Be mindful of the audio loudness)
                                                        `,
                                        },
                                        {
                                            heading   : 'How it Works', 
                                            notes     : `First, the beat map was generated by logging the time of when keys 
                                                        are pressed relative to the music. This time approximately 
                                                        corresponds to when the position of the falling circles hit the static key positions.
                                                        The actual game listens to when you press a key and compares the static key position
                                                        with the location of the falling circle - giving you a score from "Miss" to "Perfect".  
                                                        While I built out the demo rather quickly - there are numerous changes, 
                                                        fixes and features that can be made including a more precise game play system utilising
                                                        the audio timing more, auto beat-map generation, better animations, multiplayer support etc.`
                                        }
                                    ],
                demo           :    
                                    {
                                        heading   : 'Demo', 
                                        video     : '',
                                        git       : 'https://github.com/JLSeto/jimmyset0/tree/master/src/app/beat-music'
                                    },
                hardware       :    [],
                software       :    [
                                        'TypeScript',
            ...
            {
                type           : ["Tools / Other"],
                image          : "/assets/calculator/calc.png", 
            ...
            {
                type           : ["Tools / Other"],
                image          : "/assets/56_circle.svg", 
                title          : "(In progress)",
                date           : new Date("February 20, 2022"),
                subtitle       : "Typescript", 
                description    : "Example of modulating data onto a carrier signal...Eventually want to modulate the C/A PRN code onto the L1 frequency to feed into matlab scripts",
                link           : "prn",
                details        :    [
                                        { 
                                            heading   : '', 
                                            notes     : `Example of modulating data onto a carrier signal...Eventually want to modulate the C/A PRN code onto the L1 frequency to feed the data into matlab scripts to simulate coherent integration...`,
                                            img       : ""
                                        }
